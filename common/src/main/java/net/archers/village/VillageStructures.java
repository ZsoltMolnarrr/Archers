...
/// injector stays null and the archery ranges are only placed through the data-driven paths that ship in
/// `resources/data/archers` (Lithostitched worldgen modifiers, Repurposed Structures pool additions).
